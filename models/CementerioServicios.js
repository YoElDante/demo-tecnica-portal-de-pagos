/**
 * Modelo de la tabla dbo.CementerioServicios
...
module.exports = (sequelize) => {
  const CementerioServicios = sequelize.define('CementerioServicios', {
    ...
    tableName: 'CementerioServicios',
    schema: 'dbo',
    timestamps: false,
  });

  return CementerioServicios;
};
